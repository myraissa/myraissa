...
I'm a **Computer Science Engineer** specializing in **AI, Computer Vision, and NLP**, passionate about building technology that creates real social impact. Currently leading AI development at **BridgSign**, Tunisia's first real-time sign language translation startup.

```python
class MariemAissa:
    def __init__(self):
        self.role = "AI Engineer & Startup Co-Founder"
...
> **Leading AI Development** | Startup Co-Founder | Apr 2025 - Present

Breaking communication barriers for **466,000+ deaf individuals in Tunisia** through cutting-edge AI:
...
- 🔧 Optimized prompts → **40% precision increase**
...
- 🤟 **Building accessibility technology for 466,000+ deaf individuals in Tunisia**
...
```python
2026_goals = {
    "learning": ["Advanced Computer Vision", "3D Pose Estimation", "Linguistic AI"],
